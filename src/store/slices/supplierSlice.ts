...
export const createSupplier = createAsyncThunk<any , Supplier, { rejectValue: string }>(
...
})as Slice<TransactionState, typeof supplierSlice.reducers, 'supplier'> & { reducer: any };;
